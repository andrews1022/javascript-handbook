...
// 'Deterministic' means that, no matter what if my inputs, let's say five and ten go through a function, the return value will be always the same.
// Again, the input, whatever we put in the parameters whether it's empty or it has certain parameters, it always returns, even if we run this a thousand times.
